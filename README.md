About napari-medical-image-formats-feedstock
============================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-medical-image-formats-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15411&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-medical-image-formats-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-medical-image-formats` can be installed with `conda`:
...
```
mamba install napari-medical-image-formats
```

It is possible to list all of the versions of `napari-medical-image-formats` available on your platform with `conda`:
...
```
mamba search napari-medical-image-formats --channel conda-forge
```
...
mamba repoquery search napari-medical-image-formats --channel conda-forge

# List packages depending on `napari-medical-image-formats`:
mamba repoquery whoneeds napari-medical-image-formats --channel conda-forge

# List dependencies of `napari-medical-image-formats`:
mamba repoquery depends napari-medical-image-formats --channel conda-forge
```
